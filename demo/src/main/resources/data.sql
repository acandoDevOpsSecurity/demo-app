INSERT INTO PUBLIC.APPUSER (id, name, password, is_author, is_admin, is_locked, icon, private_snippet, website, color) VALUES (1,'Admin','123',FALSE,TRUE,FALSE,'default-smiley.JPG','Hi, ich bin der <strong>mächtige Administrator</strong> dieses Systems.','www.google.de','blue');
...
INSERT INTO PUBLIC.APPUSER (id, name, password, is_author, is_admin, is_locked, icon, private_snippet, website, color) VALUES (6,'Frank','123',TRUE,FALSE,FALSE,'default-smiley.JPG','Lorem ipsum text goes here....','http://www.google.de','#660000');
